import { ɵɵdefineInjectable, Injectable, EventEmitter, Component, IterableDiffers, KeyValueDiffers, ViewChild, Input, Output, NgModule } from '@angular/core';
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PlotlyService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
PlotlyComponent.ɵfac = function PlotlyComponent_Factory(t) { return new (t || PlotlyComponent)(ɵngcc0.ɵɵdirectiveInject(PlotlyService), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.IterableDiffers), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.KeyValueDiffers)); };
PlotlyComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PlotlyComponent, selectors: [["plotly-plot"]], viewQuery: function PlotlyComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, 3);
    } if (rf & 2) {
        let _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.plotEl = _t.first);
    } }, inputs: { revision: "revision", debug: "debug", useResizeHandler: "useResizeHandler", updateOnLayoutChange: "updateOnLayoutChange", updateOnDataChange: "updateOnDataChange", updateOnlyWithRevision: "updateOnlyWithRevision", data: "data", layout: "layout", config: "config", frames: "frames", style: "style", divId: "divId", className: "className" }, outputs: { initialized: "initialized", update: "update", purge: "purge", error: "error", afterExport: "afterExport", afterPlot: "afterPlot", animated: "animated", animatingFrame: "animatingFrame", animationInterrupted: "animationInterrupted", autoSize: "autoSize", beforeExport: "beforeExport", buttonClicked: "buttonClicked", click: "click", plotlyClick: "plotlyClick", clickAnnotation: "clickAnnotation", deselect: "deselect", doubleClick: "doubleClick", framework: "framework", hover: "hover", legendClick: "legendClick", legendDoubleClick: "legendDoubleClick", react: "react", relayout: "relayout", restyle: "restyle", redraw: "redraw", selected: "selected", selecting: "selecting", sliderChange: "sliderChange", sliderEnd: "sliderEnd", sliderStart: "sliderStart", transitioning: "transitioning", transitionInterrupted: "transitionInterrupted", unhover: "unhover", relayouting: "relayouting", treemapclick: "treemapclick", sunburstclick: "sunburstclick" }, features: [ɵngcc0.ɵɵProvidersFeature([PlotlyService]), ɵngcc0.ɵɵNgOnChangesFeature], decls: 2, vars: 3, consts: [[3, "className", "ngStyle"], ["plot", ""]], template: function PlotlyComponent_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PlotlyComponent, [{
        type: Component,
        args: [{
...
PlotlySharedModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: PlotlySharedModule });
PlotlySharedModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PlotlySharedModule_Factory(t) { return new (t || PlotlySharedModule)(); }, providers: [PlotlyService], imports: [[CommonModule]] });
PlotlySharedModule.ctorParameters = () => [];
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PlotlySharedModule, { declarations: function () { return [PlotlyComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [PlotlyComponent]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PlotlySharedModule, [{
        type: NgModule,
        args: [{
...
PlotlyModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PlotlyModule_Factory(t) { return new (t || PlotlyModule)(); }, providers: [PlotlyService], imports: [[CommonModule, PlotlySharedModule], PlotlySharedModule] });
PlotlyModule.plotlyjs = {};
PlotlyModule.ctorParameters = () => [];
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PlotlyModule, { imports: function () { return [CommonModule, PlotlySharedModule]; }, exports: function () { return [PlotlySharedModule]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PlotlyModule, [{
        type: NgModule,
        args: [{
                declarations: [],
...
PlotlyViaCDNModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PlotlyViaCDNModule_Factory(t) { return new (t || PlotlyViaCDNModule)(ɵngcc0.ɵɵinject(PlotlyService)); }, providers: [PlotlyService], imports: [[CommonModule, PlotlySharedModule], PlotlySharedModule] });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PlotlyViaCDNModule, { imports: function () { return [CommonModule, PlotlySharedModule]; }, exports: function () { return [PlotlySharedModule]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PlotlyViaCDNModule, [{
        type: NgModule,
        args: [{
                declarations: [],
                imports: [CommonModule, PlotlySharedModule],
...
PlotlyViaWindowModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function PlotlyViaWindowModule_Factory(t) { return new (t || PlotlyViaWindowModule)(); }, providers: [PlotlyService], imports: [[CommonModule, PlotlySharedModule], PlotlySharedModule] });
PlotlyViaWindowModule.ctorParameters = () => [];
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PlotlyViaWindowModule, { imports: function () { return [CommonModule, PlotlySharedModule]; }, exports: function () { return [PlotlySharedModule]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PlotlyViaWindowModule, [{
        type: NgModule,
        args: [{
                declarations: [],
                imports: [CommonModule, PlotlySharedModule],
